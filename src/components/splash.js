  ...
  return (
    <div className="home-page">
      <div className="home-page-content py-5">
        <h1 className="text-center py-5" style={{ color: '#', textShadow: '2px 2px #000' }}>
      ...
      <h3 className="text-center my-3 fs-4 fw-bold" style={{ color: '#FFF', textShadow: '2px 2px #000' }}>
      ...
      <div className=" d-flex justify-content-center">
        <div className="row">
          <div className="col-6">
            <NavLink to="/login" className="btn btn-block btn-outline" style={{ backgroundColor: '#96bf10', color: 'white' }}>
              Login
            </NavLink>
          </div>
          <div className="col-6">
            <NavLink to="/register" className="btn btn-block outline" style={{ backgroundColor: '#96bf10', color: 'white' }}>
              Register
            </NavLink>
          </div>
        </div>
